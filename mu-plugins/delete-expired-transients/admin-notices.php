...
namespace SuperCluster\DeleteExpiredTransients;
...
final class Admin_Notices {
	...
	private $suggestions = array(
          'index-autoload-supercluster' => array(
	          		'name' => 'Index Autoload',
          ...
          'duplicate-post-supercluster' => array(
			          'name' => 'Duplicate Post',
		      ...
		      'export-database-supercluster' => array(
			          'name' => 'Export Database',
			          'desc' => 'Quickly and easily export your WordPress database with a single click for the purposes of migration, testing, or backup (in either SQL or ZIP format).',
			          'filename' => 'export-database.php',
		      ),
		      'view-defined-constants-supercluster' => array(
		      ...
		      'header-cleanup-supercluster' => array(
			          'name' => 'Header Cleanup',
