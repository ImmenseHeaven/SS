...
namespace SuperCluster\CustomFunctions\Core;

// Aliased namespaces
use \SuperCluster\CustomFunctions\Admin;
use \SuperCluster\CustomFunctions\Core;
use \SuperCluster\CustomFunctions\File;
use \SuperCluster\CustomFunctions\Helpers;
