...
FSTHSG_Admin_Notices::instance(__FILE__);
...
if (false !== \SuperCluster\ForceStrongHashing\Admin_Notices_MS::instance(__FILE__)) {
	//return;
}
 ...
 */
class SCluster_Force_Strong_Hashing {
 ...
 * @return object
 */
function scluster_force_strong_hashing() {
	return SCluster_Force_Strong_Hashing::get_instance();
}

scluster_force_strong_hashing()->init();
